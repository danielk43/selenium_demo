...
RUN addgroup --gid ${UID} ${USER} \
 ...
 && apt update \
 && apt -y upgrade \
 && apt -y install --no-install-recommends ca-certificates curl fonts-liberation jq libasound2 \
 libatk-bridge2.0-0 libatk1.0-0 libc6 libcairo2 libcups2 libdbus-1-3 libdrm2 libexpat1 \
 ...
 libxdamage1 libxext6 libxfixes3 libxi6 libxkbcommon0 libxrandr2 libxrender1 libxss1 libxtst6 \
 lsb-release unzip wget x11vnc xdg-utils xvfb \
 && mkdir /root/.vnc \
